...
public class PlanEventPublisher {
        ...
        public void planEnviado(String profesorNombre, String directorNombre,
                ...
                publishAction("plan_enviado",
                                ...
                                String.format("El director %s ha enviado un plan de trabajo para %s", directorNombre,
                                                profesorNombre),
                                metadata);
        }
        ...
        public void planRechazadoPorProfesor(String directorIdentificacion, String profesorNombre,
                ...
                publishActionForUser("plan_rechazado_profesor",
                                ...
                                String.format("El profesor %s ha rechazado su plan de trabajo. Motivo: %s",
        ...
        public void planRechazado(String profesorNombre, String rechazadoPor,
                ...
                publishAction("plan_rechazado",
                                ...
                                String.format("Plan de %s rechazado por %s. Motivo: %s", profesorNombre, rechazadoPor,
                                                motivo),
                                metadata);
        }
        ...
        public void planRechazadoPorDirector(String profesorIdentificacion, String profesorNombre,
                ...
                publishActionForUser("plan_rechazado_director",
                                ...
                                String.format("El director %s ha rechazado el plan de trabajo. Motivo: %s",
                                                directorNombre, motivo),
                                metadata);
        }
        ...
        public void planRechazadoPorDecano(String directorIdentificacion, String profesorNombre,
                ...
                publishActionForUser("plan_rechazado_decano",
                                ...
                                String.format("El decano %s ha rechazado el plan de trabajo. Motivo: %s", decanoNombre,
                                                motivo),
                                metadata);
        }
        ...
        public void planEnviadoDecano(String decanoIdentificacion, String directorNombre,
                ...
                publishActionForUser("plan_enviado_decano",
                                ...
                                String.format("El director %s ha enviado planes del programa %s a decanatura",
                                                directorNombre, programa),
                                metadata);
        }
        ...
        public void firmaActualizada(String profesorNombre, String tipoFirma,
                ...
                publishAction("firma_actualizada",
                                "Firma Actualizada",
                                String.format("La firma de %s ha sido actualizada: %s → %s", profesorNombre, tipoFirma,
                                                estadoFirma),
                                metadata);
        }
        ...
        /**
         * Publica evento cuando el decano envía planes a Planeación.
         * Planeación será la encargada de enviarlo a Sistemas.
         */
        public void planEnviadoPlaneacion(String decanoNombre, String programa,
                        String periodo, String anio, int cantidadPlanes) {
                Map<String, Object> metadata = new HashMap<>();
                metadata.put("decanoNombre", decanoNombre);
                metadata.put("programa", programa);
                ...
                publishAction("plan_enviado_planeacion",
                                "Planes Enviados a Planeación",
                                String.format("El decano %s ha enviado %d plan(es) del programa %s a planeación",
                                                decanoNombre, cantidadPlanes, programa),
                                metadata);
        }
}
